...
export function createTabsWithContent(visual: any, visualInfos: { generalImages: any; generalInfos: any; dataImages: any; dataInfos: any; interactionImages: any; interactionInfos: any; }){
...
function createTabs(hasDataInfo: boolean, hasInteractionInfo: boolean){
