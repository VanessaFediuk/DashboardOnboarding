...
export async function showVisualChanges(selectedVisual: any) {
    let visualData = helpers.getDataOfInteractionVisual(selectedVisual);
    ...
    if(visualData && visualData.interactionChangedInfosStatus != global.infoStatus.deleted){
        ...
        if(position.pos === "left"){
            ...
            helpers.createCloseButton("closeButton", "closeButtonPlacementBig", "float: left;", helpers.removeOnboarding, "showChangesCard");
        }else{
