...
async function resetInteractionExampleInfo(){
    let titleInput = document.getElementById("titleInputInteractionExample") as HTMLInputElement | null;
    ...
    let originalGeneralInfo = helpers.getGeneralInfoInteractionExampleText();
    ...
    let nextHintInput = document.getElementById("hintInputInteractionExample") as HTMLInputElement | null;
...
async function createInteractionExampleCollapseForm(visual){
    let visualData = helpers.getDataOfInteractionVisual(visual);
    ...
    if(visualData.clickInfosStatus){
        ...
        let interactionInfo = await helpers.getInteractionExampleInteractionInfo(visual, visualData);
        let textareaAttributes = global.createTextareaAttributes();
    ...
    if(visualData.interactionChangedInfosStatus){
        ...
        let changedInfo = await helpers.getInteractionExampleChangedInfo(visual, visualData);
        let textareaAttributes = global.createTextareaAttributes();
